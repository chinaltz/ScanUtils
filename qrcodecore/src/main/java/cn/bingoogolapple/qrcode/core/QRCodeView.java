...
public abstract class QRCodeView extends RelativeLayout implements Camera.PreviewCallback {
    ...
    void onPostParseData(ScanResult scanResult) {
        ...
        String format=scanResult == null ? null : scanResult.getBarTypeName();
        if (TextUtils.isEmpty(result)) {
            ...
            try {
                if (mDelegate != null) {
                    mDelegate.onScanQRCodeSuccess(result,format);
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    public interface Delegate {
         ...
         */
        void onScanQRCodeSuccess(String result ,String codeType);
