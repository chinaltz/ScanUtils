 ...
 */
public class ISListViewHeader extends ISListViewBaseHeader {
	 ...
	 */
	public ISListViewHeader(Context context) {
		super(context);
		initView();
	}
		...
		switch(state){
			case STATE_NORMAL:
				...
				if(lastRefreshTime==null){
					lastRefreshTime = ISDateUtils.getCurrentDate(ISDateUtils.dateFormatHMS);
