package com.developer.androidutilslib.view;
...
import com.developer.androidutilslib.view.listener.ISOnItemClickListener;
import com.developer.androidutilslib.view.listener.ISOnPositionChangedListener;
import com.developer.androidutilslib.view.listener.ISOnTouchListener;
import com.isoftstone.androidutilslib.R;
import com.developer.androidutilslib.app.adapter.ISViewPagerAdapter;
 ...
 * Info 可播放显示的View
 */
public class ISBannerView extends LinearLayout {
     ...
     * 内部的ViewPager.
     */
    private ISInnerViewPager viewPager;
     ...
     * 点击.
     */
    private ISOnItemClickListener mOnItemClickListener;

    /**
     * 改变.
     */
    private ISOnPositionChangedListener mChangeListener;

    /**
     * 滚动.
     */
    private ISOnPositionChangedListener mScrolledListener;

    /**
     * 触摸.
     */
    private ISOnTouchListener mOnTouchListener;
     ...
     * 适配器.
     */
    private ISViewPagerAdapter viewPagerAdapter = null;
     ...
     */
    public ISBannerView(Context context) {
        super(context);
        initView(context);
    }
     ...
     */
    public ISBannerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }
    ...
    public void initView(Context context) {
        ...
        viewPager = new ISInnerViewPager(context);
        ...
        viewPagerAdapter = new ISViewPagerAdapter(context, mViewList);
     ...
     */
    public void setOnItemClickListener(ISOnItemClickListener onItemClickListener) {
     ...
     */
    public void setOnPageChangeListener(ISOnPositionChangedListener onChangeListener) {
     ...
     */
    public void setOnPageScrolledListener(ISOnPositionChangedListener onScrollListener) {
     ...
     */
    public void setOnTouchListener(ISOnTouchListener onTouchListener) {
