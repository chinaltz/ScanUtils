 ...
 */
public class ISPullFooter extends LinearLayout {
...
//	private ProgressBar footerProgressBar;
	 ...
	 */
	public ISPullFooter(Context context) {
		super(context);
		initView(context);
	}
	 ...
	 */
	public ISPullFooter(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
...
//		footerView.addView(footerProgressBar,layoutParamsWW);
		...
		footerView.addView(imageView,imageViewlp);
