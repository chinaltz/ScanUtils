 ...
 * </pre>
 */
public class ISBaseApplication extends Application {

    private static final String TAG = "ISBaseApplication";

    private static ISBaseApplication sInstance;

    public static ISBaseApplication getInstance() {
        return sInstance;
    }
