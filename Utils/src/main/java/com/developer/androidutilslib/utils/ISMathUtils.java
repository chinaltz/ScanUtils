...
import com.developer.androidutilslib.model.ISCircle;
import com.developer.androidutilslib.model.ISPoint;
...
public class ISMathUtils {
     ...
     * @return
     */
    public static boolean pointOnCircle(ISPoint point, ISCircle c1, ISCircle c2) {
     ...
     * @return
     */
    public static boolean pointOnCircle(ISPoint point, ISCircle c1, ISCircle c2, float offset) {
     ...
     * @return
     */
    public static boolean pointInCircle(ISPoint point, ISCircle circle) {
     ...
     * @return
     */
    public static double getDistance(ISPoint p1, ISPoint p2) {
     ...
     * @return
     */
    public static List<ISPoint> circleCrossoverPoint(ISCircle circle1, ISCircle circle2) {
        List<ISPoint> pointList = new ArrayList<ISPoint>();
        //第一个圆的参数方程:
        // x = r1 * cosCita + x1
        // y = r1 * sinCita + y1
        ...
        Set<ISPoint> pointSet = new HashSet<ISPoint>();
        ISPoint p1_1 = new ISPoint(x_1, y_1_1);
        if (pointOnCircle(p1_1, circle1, circle2)) {
            pointSet.add(p1_1);
        }

        ISPoint p1_2 = new ISPoint(x_1, y_1_2);
        ...
        ISPoint p2_1 = new ISPoint(x_2, y_2_1);
        if (pointOnCircle(p2_1, circle1, circle2)) {
            pointSet.add(p2_1);
        }

        ISPoint p2_2 = new ISPoint(x_2, y_2_2);
        if (pointOnCircle(p2_2, circle1, circle2)) {
            pointSet.add(p2_2);
        }
        for (Iterator<ISPoint> iter = pointSet.iterator(); iter.hasNext(); ) {
            ISPoint point = (ISPoint) iter.next();
            pointList.add(point);
        }
        return pointList;
    }
