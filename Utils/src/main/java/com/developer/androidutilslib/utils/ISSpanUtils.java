 ...
 * </pre>
 */
public final class ISSpanUtils {
     ...
     *             </ul>
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils setFlag(final int flag) {
        this.flag = flag;
        return this;
    }
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils setForegroundColor(@ColorInt final int color) {
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils setBackgroundColor(@ColorInt final int color) {
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils setLineHeight(@IntRange(from = 0) final int lineHeight) {
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils setQuoteColor(@ColorInt final int color) {
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils setLeadingMargin(@IntRange(from = 0) final int first,
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils setBullet(@IntRange(from = 0) final int gapWidth) {
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils setBullet(@ColorInt final int color,
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils setFontSize(@IntRange(from = 0) final int size) {
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils setFontSize(@IntRange(from = 0) final int size, final boolean isSp) {
        this.fontSize = size;
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils setFontProportion(final float proportion) {
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils setFontXProportion(final float proportion) {
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils setStrikethrough() {
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils setUnderline() {
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils setSuperscript() {
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils setSubscript() {
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils setBoldItalic() {
        isBoldItalic = true;
        return this;
    }
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils setFontFamily(@NonNull final String fontFamily) {
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils setTypeface(@NonNull final Typeface typeface) {
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils setAlign(@NonNull final Alignment alignment) {
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils setClickSpan(@NonNull final ClickableSpan clickSpan) {
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils setUrl(@NonNull final String url) {
        this.url = url;
        return this;
    }
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils setBlur(@FloatRange(from = 0, fromInclusive = false) final float radius,
                               final Blur style) {
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils setShader(@NonNull final Shader shader) {
        this.shader = shader;
        return this;
    }
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils setShadow(@FloatRange(from = 0, fromInclusive = false) final float radius,
                                 final float dx,
                                 final float dy,
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils setSpans(@NonNull final Object... spans) {
        if (spans.length > 0) {
            this.spans = spans;
        }
        return this;
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils append(@NonNull final CharSequence text) {
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils appendLine(@NonNull final CharSequence text) {
        apply(mTypeCharSequence);
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils appendImage(@NonNull final Bitmap bitmap) {
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils appendImage(@NonNull final Bitmap bitmap, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils appendImage(@NonNull final Drawable drawable) {
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils appendImage(@NonNull final Drawable drawable, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils appendImage(@NonNull final Uri uri) {
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils appendImage(@NonNull final Uri uri, @Align final int align) {
        apply(mTypeImage);
        this.imageUri = uri;
        this.alignImage = align;
        return this;
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils appendImage(@DrawableRes final int resourceId) {
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils appendImage(@DrawableRes final int resourceId, @Align final int align) {
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils appendSpace(@IntRange(from = 0) final int size) {
     ...
     * @return the single {@link ISSpanUtils} instance
     */
    public ISSpanUtils appendSpace(@IntRange(from = 0) final int size, @ColorInt final int color) {
        apply(mTypeSpace);
        spaceSize = size;
        spaceColor = color;
        return this;
