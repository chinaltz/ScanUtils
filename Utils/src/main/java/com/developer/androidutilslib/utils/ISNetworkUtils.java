 ...
 * </pre>
 */
public final class ISNetworkUtils {

    private ISNetworkUtils() {
    ...
    public static boolean isAvailableByPing(String ip) {
        ...
        ISShellUtils.CommandResult result = ISShellUtils.execCmd(String.format("ping -c 1 %s", ip), false);
        boolean ret = result.result == 0;
        if (result.errorMsg != null) {
            Log.d("ISNetworkUtils", "isAvailableByPing() called" + result.errorMsg);
        }
        if (result.successMsg != null) {
            Log.d("ISNetworkUtils", "isAvailableByPing() called" + result.successMsg);
        }
        return ret;
    }
     ...
     * @return type of network
     * <ul>
     * <li>{@link ISNetworkUtils.NetworkType#NETWORK_ETHERNET} </li>
     * <li>{@link ISNetworkUtils.NetworkType#NETWORK_WIFI    } </li>
     * <li>{@link ISNetworkUtils.NetworkType#NETWORK_4G      } </li>
     * <li>{@link ISNetworkUtils.NetworkType#NETWORK_3G      } </li>
     * <li>{@link ISNetworkUtils.NetworkType#NETWORK_2G      } </li>
     * <li>{@link ISNetworkUtils.NetworkType#NETWORK_UNKNOWN } </li>
     * <li>{@link ISNetworkUtils.NetworkType#NETWORK_NO      } </li>
     * </ul>
     */
    @RequiresPermission(ACCESS_NETWORK_STATE)
