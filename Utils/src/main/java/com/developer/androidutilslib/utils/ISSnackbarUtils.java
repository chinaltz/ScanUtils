 ...
 * </pre>
 */
public final class ISSnackbarUtils {
    ...
    private ISSnackbarUtils(final View parent) {
        setDefault();
        this.view = parent;
    }
     ...
     * @return the single {@link ISSnackbarUtils} instance
     */
    public static ISSnackbarUtils with(@NonNull final View view) {
        return new ISSnackbarUtils(view);
    }
     ...
     * @return the single {@link ISSnackbarUtils} instance
     */
    public ISSnackbarUtils setMessage(@NonNull final CharSequence msg) {
        this.message = msg;
        return this;
    }
     ...
     * @return the single {@link ISSnackbarUtils} instance
     */
    public ISSnackbarUtils setMessageColor(@ColorInt final int color) {
     ...
     * @return the single {@link ISSnackbarUtils} instance
     */
    public ISSnackbarUtils setBgColor(@ColorInt final int color) {
        this.bgColor = color;
        return this;
    }
     ...
     * @return the single {@link ISSnackbarUtils} instance
     */
    public ISSnackbarUtils setBgResource(@DrawableRes final int bgResource) {
     ...
     * @return the single {@link ISSnackbarUtils} instance
     */
    public ISSnackbarUtils setDuration(@Duration final int duration) {
     ...
     * @return the single {@link ISSnackbarUtils} instance
     */
    public ISSnackbarUtils setAction(@NonNull final CharSequence text,
     ...
     */
    public ISSnackbarUtils setBottomMargin(@IntRange(from = 1) final int bottomMargin) {
