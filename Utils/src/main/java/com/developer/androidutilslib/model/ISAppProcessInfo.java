...
public class ISAppProcessInfo implements Comparable<ISAppProcessInfo> {
	 ...
	 * @param uid the uid
	 */
	public ISAppProcessInfo(String processName, int pid, int uid) {
		super();
     ...
     */
	@Override
	public int compareTo(ISAppProcessInfo another) {
